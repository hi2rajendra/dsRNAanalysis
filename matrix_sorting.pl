#!/usr/bin/perl
#Description:Program to extract both the lines containing the given string and without the string and 
#create separate files. (cut and paste kind)
#to find RAs in 
...
my @LINES = <FILE>; 
close( FILE ); 
open (NEW, ">", "Match_Matrix_RA_only_re-sorting_hits_only_in_one_species.txt" ) or die "could not open:$!"; 
#creating new file containing the string
